...
/*
 * Roughly stolen from 
 * https://raw.githubusercontent.com/apache/lucene-solr/master/lucene/queryparser/src/java/org/apache/lucene/queryparser/flexible/standard/parser/StandardSyntaxParser.java
 * 
 ...
 */
public class CswCustomSyntaxParser implements SyntaxParser, StandardSyntaxParserConstants {


   // syntax parser constructor
   public CswCustomSyntaxParser() {
...
// }
  ...
  public CswCustomSyntaxParser(CharStream stream) {
  ...
  public CswCustomSyntaxParser(StandardSyntaxParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
