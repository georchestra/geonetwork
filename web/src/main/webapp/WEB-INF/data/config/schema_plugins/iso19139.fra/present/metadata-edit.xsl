  ...
  <xsl:template name="iso19139.fraCompleteTab">
	...
	<xsl:template name="fraTabDesc">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.fra/strings/fraTabDesc"/>
			<xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.fra/strings/fraTabDesc)"/>
	...
	<xsl:template name="fraTabTech">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.fra/strings/fraTabTech"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.fra/strings/fraTabTech)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="fraTabQua">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.fra/strings/fraTabQua"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.fra/strings/fraTabQua)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="fraTabAcc">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.fra/strings/fraTabAcc"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.fra/strings/fraTabAcc)"/>
			<xsl:with-param name="content">
	...
	<xsl:template name="fraTabMd">
		...
		<xsl:call-template name="complexElementGuiWrapper">
		  <xsl:with-param name="title" select="/root/gui/schemas/iso19139.fra/strings/fraTabMd"/>
		  <xsl:with-param name="id" select="generate-id(/root/gui/schemas/iso19139.fra/strings/fraTabMd)"/>
			<xsl:with-param name="content">
